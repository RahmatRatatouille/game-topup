                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4"><img src="<?= base_url('assets/img/logo.png'); ?>" height="80px" alt=""><strong>Eleven Store</strong></h1>
                                </div>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="forgot-password.html">Lupa Password Kah...?</a>
                                </div>
                                <div class="text-center">
